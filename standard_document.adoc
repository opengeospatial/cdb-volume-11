...
:titletext: Volume 11: OGC CDB Core Standard Conceptual Model
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/CDB-core-model/1.3
|Internal reference number of this OGC(R) document:        16-007r6
|Version: 1.3
|Category: OGC® Implementation Standard
|Editor:       Sara Saeedi, David Graham
|===
...
|===
|*Copyright notice*
|Copyright (C) 20213Open Geospatial Consortium
...
include::clause_1_overview.adoc[]

include::clause_2_cdb_general_data_organization.adoc[]

include::clause_3_metadata_schema.adoc[]

include::clause_4_3D_model_extensions.adoc[]

include::clause_5_feature_data_dictionary.adoc[]
